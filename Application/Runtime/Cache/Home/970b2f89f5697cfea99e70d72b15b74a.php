...
<!-- saved from url=(0062)http://study.163.com/user/setting.htm#/settings/personInfoEdit -->
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh" lang="zh">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>帐号设置 - 网易云课堂</title>
...
<div class="f-pf g-headwrap" id="j-fixed-head">
  ...
  <div class="g-hd f-bg1 m-yktNav " id="j-topnav" style="background:#000;">
    <div class="g-flow" >
      <div class="f-pr f-cb">
        <div class="m-logo f-cb"> <a class="f-fl" hidefocus="true" href="" target="_self" data-index="网易云课堂logo"> <img class="f-fl img" src="./imgs/logo3.png" title="云课堂" width="153" height="28"> </a> </div>
        ...
        <div class="m-navrgt f-fr f-cb f-pr j-navright">
          <div class="userinfo f-fr f-cb f-pr">
            <div class="login f-cb">
              <div class="name j-userinfo" id="auto-id-1449497480752">
                <div class="f-pr">
                  <div class="face"> <img class="j-nav-myimg" src="./imgs/small.jpg" width="30px" height="30px" alt="头像"> </div>
                  <div class="u-navusermenu j-nav-set x-hide">
                    <div class="arrr f-pa"></div>
                    <ul class="menu">
                      <li class="text"> <a data-index="点击用户名" class="self f-thide" target="_self" href=""> <span class="f-fc3 f-fs1 f-f0">ypl189a ,</span><br>
                        <span class="s-fc2">正使用“网易邮箱”帐号登录</span> </a> </li>
                      <li class="j-addCourse" style="display:none"> <a class="self" target="_blank">创建课程</a> </li>
                      <li class="j-mngCourse" style="display:none"> <a class="self" target="_self">课程管理</a> </li>
                      <li class="j-mngCourse" style="display:none"> <a class="self" target="_self">课程管理</a> </li>
                      <li> <a href="" class="self j-uhref" data-index="点击用户名">个人主页</a> </li>
                      <li class="j-yoctch" style="display:none"> <a href="" class="self">设置老师信息</a> </li>
                      <li> <a href="" class="reply" data-index="反馈意见">反馈意见</a> </li>
                      <li> <a href="" class="setting" data-index="设置">设置</a> </li>
                      <li> <a href="" class="exit" data-index="退出">退出</a> </li>
                    </ul>
                  </div>
                </div>
              </div>
              <a class="cart f-pr f-cb" data-index="课程包" href=" title="查看我的课程包" target="_blank"> <span>课程包</span> <em class="num f-dn j-nav-cartnum">0</em> </a> <a class="mes f-pr f-cb" data-index="消息" href="" title="查看更多消息" target="_blank"> <span>消息</span> <em class="num f-dn j-nav-msgnum">0</em> </a> </div>
          </div>
          <div class="nav-search u-navsearchUI j-searchP">
            <div class="box off j-search f-cb">
              ...
              <input type="text" class="j-input f-fl" data-index="搜索" id="auto-id-1449497480762">
              <label class="j-label" id="auto-id-1449497480760">搜索</label>
            </div>
            <div class="j-suggest u-navsearchsug"></div>
          </div>
        </div>
        <div class="m-nav f-cb j-navFind"> <a data-index="首页" class="nitem" href="" hidefocus="true">首页</a>
          <div class="f-pr f-cb nitem x-hoverItem"> <span>课程体系</span>
            <div class="f-pa u-navdropmenu x-child"> <span class="arrr f-pa"></span> 
			<a data-index="大学计算机专业" class="dropitem f-f0" href="" hidefocus="true"> 
			<span>大学计算机专业</span> </a> <a data-index="互联网职业技能" class="dropitem f-f0" href="" hidefocus="true"> 
			<span>互联网职业技能</span></a>
			<a data-index="金融专业" class="dropitem f-f0 last" href="" hidefocus="true"> <span>金融专业</span> </a> </div>
          </div>
          <a data-index="微专业" class="nitem" href="" hidefocus="true">微专业</a>
          <div class="nitem  x-hoverItem" hidefocus="true"> 
		  <span class="j-dropmenubtn" id="auto-id-1449497480773">下载APP</span>
            <div class="u-navapptip f-pa x-child">
              <div class="arrr f-pa"></div>
              <img src="./imgs/nav_qrcode.png" class="ewm f-fl" alt="下载APP" title="下载APP">
              <div class="rcon f-fr">
                <h4 class="txt">扫码下载官方App</h4>
                <a data-index="appstore下载" href="" target="_blank" class="store apple"></a> 
				<a data-index="android下载" href="" target="_blank" class="store android"></a> </div>
            </div>
          </div>
            ...
            <div class="j-personEditbox editBox">
              <table>
                <tbody>
                    ...
                    <td><div class="j-nickName eBcon auto-1449497480701-parent">
                        <div class="m-nicknameui u-insug f-cb auto-1449497480701">
                          <div class="area j-inputArea f-fl" style="width: 175px; height: 25px;">
                            <input type="text" name="username" "class="j-input" id="auto-id-1449497480845" placeholder="表现真正技术的时刻到了" style="width: 175px; height: 25px;"><span id="sp1" style="width:120px;float:left;margin-left:200px;margin-top:-20px;color:red;"></span>
                          </div>
                  ...
                  <tr>
                    <td class="title"><em class="f-sign" style="float:left;margin-left:4px;margin-top:-1px;">必*填</em>邮箱</td>
                    <td><div class="j-mail eBcon">
                        <div class="accMail">
						  <div style="border:1px solid #ccc;float:left;margin-top:5px;">
							<input type="email" name="email" placeholder="请输入常用的邮箱" style="width:180px;height:30px;"/>
						  </div>
						  <span id="sp2" style="float:left;margin-left:10px;margin-top:15px;"></span>
                          <div class="j-mailTxt mailTxt auto-1449497480626-parent" style="margin-top: -5px;">
                            <div class="m-feedbackinfo auto-1449497480626">
                              <div class="warningbox j-warningbox f-cb"><span class="j-warningicon right"></span><span class="warning j-warning righttxt"></span></div>
                              <div class="loadingbox j-loadingbox f-cb" style="display: none;"><span class="icon"></span><span class="loading j-loading"></span></div>
                            </div>
                          </div>
                        </div>
                      </div></td>
                  ...
                  <tr>
                    ...
                    <td><div class="sex eBcon">
                        ...
                        <input id="privacy" value="10"type="radio" name="sex" class="j-sex">
                          ...
                          <div class="inputbox">
                            <div class="input j-input auto-1449497480618-parent">
                              <div class="m-baseinputui auto-1449497480618" style="width: 395px; height: 74px;">
                                <textarea name="inputtxt" class="j-textarea inputtxt" id="auto-id-1449497480889" style="width: 395px; height: 74px;"></textarea>
                                <label class="j-hint inputhint" for="inputtxt" id="auto-id-1449497480887">请输入个人介绍</label>
                              </div>
                            </div>
                    ...
                    <td><div class="f-fl rnIpt f-cb">
                        <div class="j-rnIpt auto-1449497480618-parent">
                          <div class="m-baseinputui auto-1449497480618" style="width: 285px; height: 23px;">
                            <input type="text" name="realname" placeholder="请输入姓名"style="height:25px;"/>
                  ...
                  <tr>
                    ...
                    <td><div class="f-fl phoneIpt f-cb">
                        <div class="j-phoneIpt auto-1449497480618-parent">
                          <div class="m-baseinputui auto-1449497480618" style="width: 285px; height: 23px;">
                            <input type="text" name="phone" placeholder="请输入手机号"style="height:25px;"/>
                  ...
                  <tr>
                    ...
                    <td><div class="f-fl qqIpt f-cb">
                        <div class="j-qqIpt auto-1449497480618-parent">
                          <div class="m-baseinputui auto-1449497480618" style="width: 285px; height: 23px;">
                            <input type="text" name="realname" placeholder="请输入您的球球号"style="height:25px;"/>
                    ...
                    <td><div class="f-cb">
                        <div class="f-fl sfzIpt">
                          <div class="j-idNumIpt auto-1449497480618-parent">
                            <div class="m-baseinputui auto-1449497480618" style="width: 285px; height: 23px;">
                              <input type="text" name="realname" placeholder="请输入您的唯一标识"style="height:25px;"/>
                        ...
                        <div class="u-sugInput">
                          <div class="iptArea f-cb">
                            <div class="ipt">
                              <div class="u-insug">
                                <div class="area">
                                  <input type="text" name="good" placeholder="体现真正技术的时候到了"style="height:25px;"/>
                                </div>
                              </div>
                            </div>
							</div>
    ...
    <div class="g-flow ftwrapper f-cb">
      <div class="f-fl ftlf">
        ...
        <div class="share f-cb">
          <p class="tit">关注我们：</p>
          <a href="" class="weibo" target="_blank" data-index="关注我们_微博"></a> <a href="" class="renren" target="_blank" data-index="关注我们_人人"></a> <a href="javascript:void(0)" class="yixin f-pr" data-index="关注我们_易信">
          <div class="tipQrcode f-pa">
            <div class="qrImag"> <img src="./imgs/yixin.png" width="120px" height="120px" alt="加云课堂易信好友"> </div>
            <p class="qrTitle">易信号：study163</p>
            <div class="tip f-pa"></div>
          </div>
          </a> <a href="javascript:void(0)" class="weixin f-pr" data-index="关注我们_微信">
          <div class="tipQrcode f-pa">
            <div class="qrImag"> <img src="./imgs/weixin.png" width="120px" height="120px" alt="加云课堂微信好友"> </div>
