    ...
    <div class="g-flow">
      ...
      <div class="topheader f-pr f-cb">
        <div class="logo f-fl f-cb">
		  <img class="f-fl img" usemap="#Map" src="/godzmooc/Public/Upload/<?php echo ($configs["logo"]); ?>" alt="GodZmooc" width="500" height="100">
          <map name="Map">
            <area hidefocus="true" data-index="GodZmooclogo" title="GodZmooc" target="_self" href="/godzmooc" coords="56,40,250,75" shape="RECT">
          </map>
        </div>
    ...
    <div class="g-flow ftwrapper f-cb">
      <div class="f-fl ftlf">
        ...
        <div class="share f-cb">
          ...
          <div class="tipQrcode f-pa">
            <div class="qrImag"> <img src="/godzmooc/Public/Home/imgs/weixin.png" width="120px" height="120px" alt="加GodZmooc微信好友"> </div>
