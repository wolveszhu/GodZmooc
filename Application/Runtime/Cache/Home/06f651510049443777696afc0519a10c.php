...
<link href="/study/Public/Home/css/loginout.css" type="text/css" rel="stylesheet">
</head>
        ...
        <div class="m-navrgt f-fr f-cb f-pr j-navright">
		 ...
		 <!-- <?php if($_SESSION["id"] != null): ?><div id="login">
			...
			<div id="login1">
				...
				<div><a href="/study/index.php/Login/loginout/id/<?php echo ($_SESSION["id"]); ?>">退出</a></div>
			</div>
		 </div><?php endif; ?> -->
...
<div class="g-flow"> <b class="b-20"></b>
  <div class="g-logout f-bg">
    <div class="m-logcnt f-pr"> <b class="b-30"></b><b class="b-30"></b>
      ...
      <p class="sug f-fs0">有意见或建议？<a href="/study/index.php/User/advice" target="_blank">反馈给我们<span class="f-ib feedicon"></span></a></p>
      <a class="reLogin btn" id="j-reLogin" style="color:#26A266" href="/study/index.php/Login/index">重新登录</a>
      <div class="f-pa toiPad">
        <p>云课堂App</p>
        <a href="#" target="_blank">查看详情&gt;&gt;<br/><img src="/study/Public/Home/imgs/loginout(1).png"></a>
        ...
        <div class="share f-cb">
		  ...
		  <a href="javascript:void(0)" class="yixin f-pr" data-index="关注我们_易信">
			...
			<div class="tipQrcode f-pa">
				<div class="qrImag">
					<img src="/study/Public/Home/imgs/yixin.png" width="120px" height="120px" alt="加云课堂易信好友">
				</div>
				<p class="qrTitle">易信号：study163</p>
				<div class="tip f-pa"></div>
			</div>
          </a> 
		  <a href="javascript:void(0)" class="weixin f-pr" data-index="关注我们_微信"><img src="/study/Public/Home/imgs/4.png">
			  <div class="tipQrcode f-pa">
				<div class="qrImag">
