...
<div id="personal">
	<div>
		...
		<div>
			<?php if($data["sex"] == 1): ?><img src="/study/Public/Home/imgs/b.bmp"/>
			<?php elseif($data["sex"] == 0): ?>
			<img src="/study/Public/Home/imgs/g.bmp"/>
			<?php else: ?>
			<img src="/study/Public/Home/imgs/n.jpg"/><?php endif; ?>
		</div>
	</div>
	<div>
		<div>
			<a href="/study/index.php/Detail/index/id/<?php echo ($_SESSION["id"]); ?>">编辑我的资料</a>
			<a href="/study/index.php/Detail/personalCenter">前往个人首页</a>
		</div>
		<div>
			<div>
