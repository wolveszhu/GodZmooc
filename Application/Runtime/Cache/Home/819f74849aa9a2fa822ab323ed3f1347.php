    ...
    <div class="m-orgcentertop f-pr">
      <div class="j-headInfo headInfo">
        <div class="m-uinfo j-uinfo infobg">
          <div class="g-flow f-cb f-pr"> <a id="auto-id-1450352531655" title="刺客ykt1450352485246" class="f-fl face j-userurl"> <img src="/study/Public/Upload/<?php echo ($users["pic"]); ?>" class="j-userface" width="60px" height="60px"> </a>
            <div class="f-fl f-pr introarea">
              <div class="baseInfo f-pr">
                <div class="f-cb"> <a id="auto-id-1450352531656" class="f-fl j-nickinfo nickinfo"> <span class="username f-fl j-nickname"><?php echo ($per["username"]); ?></span> <span style="display: none;" class="usersex j-usersex f-fl"></span> </a> </div>
          ...
          <div id="person-course-box" class="personCourse">
            <div class="g-mn2">
              <div class="g-mn2c f-bg j-coursewrapper">
                <div class="j-tabs courseTabs"> <a id="auto-id-1450352531621" class="f-ib f-pa tab1 cur">参加的课程</div>
                ...
                <div style="" class="j-none u-emptybig">
                  <div class="emptytext"><img src="/study/Public/Home/imgs/per.png">
            ...
            <div class="g-sd2 f-bg">
              <div class="m-center-side">
                <div class="top">
                  ...
                  <a class="f-fr" href="/study/index.php/Detail/personal">更多</a> </div>
                <div class="bottom">
