...
<div id="advertisement_box" class="advertisement_box f-pf" style="display:none;"></div>
	...
	<style type="text/css">
		#foot{
			width:100%;
			height:200px;
			background:url('/study/Public/Home/imgs/foot.png') no-repeat;
		}
	...
	<div class="m-app">
				<div style="display:block;background:url('/study/Public/Home/imgs/yun.png');width:100%;height:440px;top: 60px;">
					<a href="/study/Public/Download/study-ios-official.apk">iPhone版</a>
					<a href="/study/Public/Download/study-ipad-official.apk">iPad版</a>
					<a href="/study/Public/Download/study-android-official.apk">安卓版</a>
					<input type="hidden"value="<?php echo ($_SESSION["id"]); ?>" name="in"/>
				</div>
				<div class="sections">
				<div class="g-flow">
					<div class="sec sec1 f-cb">
						<div class="f-fl f-pr pics" style="width:600px;height:600px;background:url('/study/Public/Home/imgs/play.png') no-repeat;margin-left:-50px;margin-top:-130px;">
						</div>
					...
					<div class="sec sec2 f-cb">
						<div class="f-fr f-pr pics"style="width:600px;height:600px;background:url('/study/Public/Home/imgs/fun.png') no-repeat;margin-top:-150px;" >
						</div>
					...
					<div class="sec sec3 f-cb">
						<div class="f-fl f-pr pics"style="width:600px;height:600px;background:url('/study/Public/Home/imgs/enjoy.png') no-repeat;margin-top:-280px;margin-left:-40px;">
						</div>
						<div class="f-fr f-pr content">
							<h2>离线学习</h2>
		...
		<div>
			<div>
				<div id="foot" style="">
					<a href="/study/Public/Download/study-android-official.apk" class="f-fr f-f0 dbtn android">安卓版</a>
					<a href="/study/Public/Download/study-ipad-official.apk" class="f-fr f-f0 dbtn ios">iPad版</a>
					<a href="/study/Public/Download/study-ios-official.apk" class="f-fr f-f0 dbtn ios">iPhone版</a>
				</div>
			</div>
		</div>
	</div>
	<script type="text/javascript" charset="utf-8">
		$(".m-app a").click(function(){	
			...
			$.ajax({
				type:"GET",
				url:"/study/index.php/User/Download",
