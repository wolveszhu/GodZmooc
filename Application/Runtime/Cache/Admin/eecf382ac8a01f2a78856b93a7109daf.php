    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/godzmooc/admin.php/Adv/index' method="get">
                    <div class="seachform">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form action="/godzmooc/admin.php/Adv/del">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($advs)): foreach($advs as $key=>$adv): ?><tbody> 
										<tr>
                                            ...
                                            <td class="hidden-480"><img src="/godzmooc/Public/Upload/<?php echo ($adv["pic"]); ?>" width="40px" height="40px"></td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a  href='/godzmooc/admin.php/Adv/mod/id/<?php echo ($adv["id"]); ?>'>
                                                        修改 |
                                                    </a>

                                                    <a href='/godzmooc/admin.php/Adv/del/id/<?php echo ($adv["id"]); ?>'>
                                                        删除 
                                                    </a>
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="inline position-relative">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="/godzmooc/admin.php/Adv/mod/id/{adv.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="/godzmooc/admin.php/Adv/del/id/{adv.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
