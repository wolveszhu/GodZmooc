					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/study/admin.php/Type/mod_son">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 修改子版块 </label>

										<div class="col-sm-9">
											<input  type="text" value="<?php echo ($type_son["name"]); ?>" name="name" class="col-xs-10 col-sm-5" id="form-input-readonly" placeholder="添加子版块" />
											<input  type="hidden"  name="id" value="<?php echo ($_GET['id']); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" />
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<input type="submit" class="btn btn-info"  name="sub" value="确认添加"/>
