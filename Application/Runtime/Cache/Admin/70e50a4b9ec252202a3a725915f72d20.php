					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/study/admin.php/Type/mod_parent">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 修改分区 </label>

										<div class="col-sm-9">
											<input  type="text"  name="name" value="<?php echo ($type["name"]); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" placeholder="修改分区" />
