...
<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
						 ...
						 <form action='/godzmooc/admin.php/User/index' method="get">
							<div class="seachform" >
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/godzmooc/admin.php/User/del">
													...
													<tr>
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/godzmooc/admin.php/User/status/id/<?php echo ($user["id"]); ?>/status/<?php echo ($user["status"]); ?>">
																	<i class="icon-lock">
																...
																<a class="blue" href="/godzmooc/admin.php/User/select/id/<?php echo ($user["id"]); ?>">
																...
																<a class="green" href="/godzmooc/admin.php/User/mod/id/<?php echo ($user["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" href="/godzmooc/admin.php/User/del/id/<?php echo ($user["id"]); ?>">
