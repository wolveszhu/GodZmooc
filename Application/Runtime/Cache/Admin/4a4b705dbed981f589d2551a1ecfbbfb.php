        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action='/godzmooc/admin.php/Teacher/mod' role="form" method='post' enctype="multipart/form-data" >
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                               ...
                               <!--<a href='/godzmooc/admin.php/Teacher/index' class="btn btn-info" type="submit" name='sub'>
