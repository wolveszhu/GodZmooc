					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/GodZmooc/admin.php/Group/mod">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 管理组名称</label>

										<div class="col-sm-9">
											<input  type="text"  name="title" value="<?php echo ($group["title"]); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" />
											<input  type="hidden"  name="id" value="<?php echo ($group["id"]); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" />
