					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/study/admin.php/Type/add_son">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 添加子版块 </label>

										<div class="col-sm-9">
											<input  type="text"  name="name" class="col-xs-10 col-sm-5" id="form-input-readonly" placeholder="添加子版块" />
											<input  type="hidden"  name="pid" value="<?php echo ($_GET['id']); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" />
