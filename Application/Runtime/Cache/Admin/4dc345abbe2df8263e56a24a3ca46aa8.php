...
<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
						 ...
						 <form action='/wyiEdu/admin.php/Auth/ruleIndex' method="get">
							<div class="seachform" >
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/wyiEdu/admin.php/Auth/delRule">
													...
													<tr>
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/wyiEdu/admin.php/Auth/modStatus/id/<?php echo ($rule["id"]); ?>/status/<?php echo ($rule["status"]); ?>">
																	<i class="icon-lock">
																...
																<a class="green" href="/wyiEdu/admin.php/Auth/modRule/id/<?php echo ($rule["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" href="/wyiEdu/admin.php/Auth/delRule/id/<?php echo ($rule["id"]); ?>">
