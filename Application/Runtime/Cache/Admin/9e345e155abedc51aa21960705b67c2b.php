        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="/study/admin.php">后台主页</a>
                </li>

                <li>
                    <a href="#">合作机构管理</a>
                </li>
                <li class="active">修改合作机构</li>
            </ul><!-- .breadcrumb -->
        </div>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action='/study/admin.php/Organ/mod' role="form" method='post' >
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" id="username" name="username" for="form-field-1"> 合作机构名称 </label>

                            <div class="col-sm-9">
                                <input type="text"  class="col-xs-10 col-sm-5"  name='name' value="<?php echo ($organ["name"]); ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name='url' value="study/admin.php/Organ/index.html"  class="col-xs-10 col-sm-5" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea  type="text"  name='description' value="<?php echo ($organ["description"]); ?> class="col-xs-10 col-sm-5" style="width:325px;height:150px">
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                               ...
                               <input type='hidden' name='id' class="btn btn-info" value='<?php echo ($organ["id"]); ?>'/>
                              
                               <!--<a href='/study/admin.php/Organ/index' class="btn btn-info" type="submit" name='sub'>
