					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/study/admin.php/Course/mod">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 修改课时标题</label>

										<div class="col-sm-9">
											<input  type="text"  name="name" value="" class="col-xs-10 col-sm-5" id="form-input-readonly" placeholder="<?php echo ($course["name"]); ?>"/>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<input type="submit" class="btn btn-info"  name="sub" value="确认修改"/>
