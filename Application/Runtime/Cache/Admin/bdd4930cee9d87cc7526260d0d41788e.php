    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/study/admin.php/Type/select/id/<?php echo ($id); ?>' method="get">
                    <div class="seachform">
                        视频名称: <input name="title" type="text" class="scinput" />
                        &nbsp;&nbsp;&nbsp;<input type="submit" name="sub" class="btn btn-primary btn-xs"  value="查询"/>
                    </div>
                </form>
				   <br>
                    <div class="seachform">
                       
                       <a href="/study/admin.php/Type/add_video/tid/<?php echo ($id); ?>"  class="btn btn-primary btn-xs">添加</a>
                    </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form action="/study/admin.php/Type/del_video" method="post">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($videos)): foreach($videos as $key=>$video): ?><tbody> 
										<tr>
                                            ...
                                            <td><?php echo ($video["tname"]); ?></td>
                                         
                                            <td class="hidden-480">
											
												<img src="/study/Public/Upload/<?php echo ($video["video"]); ?>" width="40" height="40">
											</td>
											 <td><?php echo ($video["price"]); ?></td>
											 <td><?php echo ($video["number"]); ?></td>
											 
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                 
                                                    <a onclick=" return confirm('你确定删除吗？')" href='/study/admin.php/Type/del_video/id/<?php echo ($video["id"]); ?>'>
                                                        删除 
                                                    </a>
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="inline position-relative">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="/study/admin.php/Type/mod/id/{video.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="/study/admin.php/Type/del/id/{video.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
