    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/godzmooc/admin.php/Video/index' method="get">
                    <div class="seachform">
                        视频名称: <input name="title" type="text" class="scinput" placeholder="请输入视频名称" />
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form action="/godzmooc/admin.php/Video/del" method="post">
                                    ...
                                    <?php if(is_array($videos)): foreach($videos as $key=>$video): ?><tbody> 
										<tr>
                                            ...
                                            <td class="hidden-480">
												...
												<img src="/godzmooc/Public/Upload/<?php echo ($video["video"]); ?>" width="40" height="40">
											</td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
													...
													<a  href='/godzmooc/admin.php/Video/mod/id/<?php echo ($video["id"]); ?>'>
                                                        修改 |
                                                    </a>
                                                    <a onclick=" return confirm('你确定删除吗？')" href='/godzmooc/admin.php/Video/del/id/<?php echo ($video["id"]); ?>'>
                                                        删除 
                                                    </a>
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="inline position-relative">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="/godzmooc/admin.php/Video/mod/id/{video.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="/godzmooc/admin.php/Video/del/id/{video.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
