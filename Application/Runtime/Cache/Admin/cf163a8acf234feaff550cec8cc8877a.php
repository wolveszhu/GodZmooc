				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="/godzmooc/admin.php/Download/index" method ="post" >
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									...
									<!-- 	<td>
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
												<a class="blue" href="/godzmooc/admin.php/Download/status/id/<?php echo ($configs["id"]); ?>/status/<?php echo ($configs["status"]); ?>">
													<i class="icon-zoom-in bigger-130">
													</i>
												</a>
												<a class="green" href="/godzmooc/admin.php/Download/mod/id/<?php echo ($configs["id"]); ?>">
