					...
					<div class="page-content">
						<div class="page-header">
							<h1>
							 ...
							 <form action='/godzmooc/admin.php/Group/index' method="get">
							<div class="seachform" >
							管理组名: <input name="title" type="text" placeholder="请输入组名" class="scinput" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/godzmooc/admin.php/Group/del">
											...
											<?php $num = '1'; ?>
											<?php if(is_array($groups)): foreach($groups as $key=>$group): ?><tbody>
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" name="id[]" value="<?php echo ($group["id"]); ?>" class="ace" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td class="hidden-480">
														<?php if(is_array($group['rules'])): foreach($group['rules'] as $key=>$rule): ?><i class="icon-circle"></i>
														 <?php echo ($rule["title"]); ?>　<?php endforeach; endif; ?>
														</td>
														<td><?php echo ($group['status'] ? "启用" :"禁用"); ?></td>

														<td>
														
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/godzmooc/admin.php/Group/status/id/<?php echo ($group["id"]); ?>/status/<?php echo ($group["status"]); ?>">
																	<i class="icon-lock">
																		<?php echo ($group['status'] ? "禁用":"启用"); ?>
																	
																	</i>
																	
																</a>

																<a class="green" href="/godzmooc/admin.php/Group/mod/id/<?php echo ($group["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" href="/godzmooc/admin.php/Group/del/id/<?php echo ($group["id"]); ?>">
