					...
					<div class="page-content">
						<div class="page-header">
							<h1>
							 ...
							 <form action='/admin.php/Group/index' method="get">
							<div class="seachform" >
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/admin.php/Group/del">
													...
													<tr>
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/admin.php/Group/status/id/<?php echo ($group["id"]); ?>/status/<?php echo ($group["status"]); ?>">
																	<i class="icon-lock">
																...
																<a class="green" href="/admin.php/Group/mod/id/<?php echo ($group["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" href="/admin.php/Group/del/id/<?php echo ($group["id"]); ?>">
