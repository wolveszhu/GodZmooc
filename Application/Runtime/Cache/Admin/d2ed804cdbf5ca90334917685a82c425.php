					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/study/admin.php/Auth/modRule">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 权限规则 </label>

										<div class="col-sm-9">
											<input  type="text"  name="name" value="<?php echo ($rule["name"]); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" />
											<input  type="hidden"  name="id" value="<?php echo ($rule["id"]); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" name="title" value="<?php echo ($rule["title"]); ?>"  class="col-xs-10 col-sm-5" />
