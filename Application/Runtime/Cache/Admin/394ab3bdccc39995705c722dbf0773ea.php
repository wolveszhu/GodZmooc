    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/study/admin.php/Info/index' method="get">
                    <div class="seachform">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form action="/study/admin.php/Info/del">
										...
										<tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a  href='/study/admin.php/Info/mod/id/<?php echo ($info["id"]); ?>'>
                                                        修改 |
                                                    </a>

                                                    <a onclick="return confirm('你确认删除吗')" href='/study/admin.php/Info/del/id/<?php echo ($info["id"]); ?>'>
                                                        删除 
                                                    </a>
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="inline position-relative">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <li>
                                                                <a href="/study/admin.php/Info/mod/id/{infos.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="/study/admin.php/Info/del/id/{infos.id}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                    <span class="red">
