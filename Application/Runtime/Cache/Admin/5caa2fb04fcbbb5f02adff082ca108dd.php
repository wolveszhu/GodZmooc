        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action='/study/admin.php/News/mod' role="form" method='post' >
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" id="username" name="title" for="form-field-1"> 新闻标题 </label>

                            <div class="col-sm-9">
                                <input type="text"  class="col-xs-10 col-sm-5"  name='title' value="<?php echo ($news["title"]); ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea  type="text"  name='content' value="<?php echo ($news["content"]); ?> class="col-xs-10 col-sm-5" style="width:325px;height:150px">
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                               ...
                               <input type='hidden' name='id' class="btn btn-info" value='<?php echo ($news["id"]); ?>'/>
                              
                               <!--<a href='/study/admin.php/News/index' class="btn btn-info" type="submit" name='sub'>
