					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/GodZmooc/admin.php/Admin/mod" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 管理员名称</label>

										<div class="col-sm-9">
											<input  type="text"  name="name" value="<?php echo ($admin["name"]); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" />
											<input  type="hidden"  name="id" value="<?php echo ($admin["id"]); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">管理组名</label>
