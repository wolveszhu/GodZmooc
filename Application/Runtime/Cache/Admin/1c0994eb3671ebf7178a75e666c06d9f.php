					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/godzmooc/admin.php/User/mod">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 邮箱 </label>

										<div class="col-sm-9">
											<input  type="email"  name="email" value="<?php echo ($user["email"]); ?>" class="col-xs-10 col-sm-5" id="form-input-readonly" />
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<input class="input-sm" type="hidden" name ="id" id="form-field-4" value="<?php echo ($user["id"]); ?>" />
