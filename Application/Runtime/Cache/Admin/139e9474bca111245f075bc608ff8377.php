...
<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
						 ...
						 <form action='/godzmooc/admin.php/Advice/index' method="get">
							<div class="seachform" >
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/godzmooc/admin.php/Advice/del">
											...
											<?php if(is_array($datas)): foreach($datas as $key=>$data): ?><tbody>
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" name="id[]" value="<?php echo ($data["id"]); ?>" class="ace" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="red" href="/godzmooc/admin.php/Advice/del/id/<?php echo ($data["id"]); ?>">
