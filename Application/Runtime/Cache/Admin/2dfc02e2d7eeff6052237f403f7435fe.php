        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action='/GodZmooc/admin.php/News/add' role="form" method='post' >
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                               ...
                               <!--<a href='/GodZmooc/admin.php/News/index' class="btn btn-info" type="submit" name='sub'>
