...
<div class="main-content">
					...
					<div class="page-content">
						...
						<!--搜索-->
						<form class="form-search" method="get" action="/godzmooc/admin.php/Course/index">
							<div>
								<span>课时标题：</span>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/godzmooc/admin.php/Course/del" method="post">
												...
												<?php if(is_array($courses)): foreach($courses as $key=>$course): ?><tr>
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/godzmooc/admin.php/Course/mod/id/<?php echo ($course["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" onclick="return confirm('你确认要删除吗')" href="/godzmooc/admin.php/Course/del/id/<?php echo ($course["id"]); ?>">
