					...
					<div class="page-content">
						<div class="page-header">
							<h1>
							 ...
							 <form action='/godzmooc/admin.php/Admin/index' method="get">
							<div class="seachform" >
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/godzmooc/admin.php/Admin/del">
											...
											<?php if(is_array($admins)): foreach($admins as $key=>$admin): ?><tbody>
													<tr>
														...
														<td class="hidden-480">
															...
															<img src="/godzmooc/Public/Upload/<?php echo ($admin["photo"]); ?>" width="40" height="40">
														</td>
														<td><?php echo ($admin['status'] ? "启用" :"禁用"); ?></td>
														<td>
															<a href="/godzmooc/admin.php/Group/index/title/<?php echo ($admin["title"]); ?>" class="btn btn-app btn-pink btn-sm">
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/godzmooc/admin.php/Admin/status/id/<?php echo ($admin["id"]); ?>/status/<?php echo ($admin["status"]); ?>">
																	<i class="icon-lock">
																...
																<a class="green" href="/godzmooc/admin.php/Admin/mod/id/<?php echo ($admin["id"]); ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>

																<a class="red" href="/godzmooc/admin.php/Admin/del/id/<?php echo ($admin["id"]); ?>">
